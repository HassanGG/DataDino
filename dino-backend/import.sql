...
VALUES ('3b3d3341-f7aa-485f-94ac-2c36062af1f6', false, 5, 5432, -124123, 0.05, 'A bunch of numbers', 'Special Numbers', 1647263239);
...
INSERT INTO dataset (id, archived, datapoint_count, datapoint_max, datapoint_min, datapoint_price, description, name, uploaded_at)
VALUES ('0ebff3b0-0924-4c91-b1c5-29f4b29cc194', false, 5, 2342, -234, 0.02, 'more numbers', 'Just, you know, some numbers', 1710614691);
INSERT INTO data (id, data, dataset_id)
VALUES ('2be44ae7-822c-41a0-b5f0-c24df7a56e8a', '2342, 234, 112, 0, -234', '0ebff3b0-0924-4c91-b1c5-29f4b29cc194');
INSERT INTO dataset (id, archived, datapoint_count, datapoint_max, datapoint_min, datapoint_price, description, name, uploaded_at)
VALUES ('d99bca2f-ca4e-42b3-8e26-bc196386cc08', false, 7, 643, 6, 1.5, 'You\'re shoe\'s untied', 'Shoe sizes', 1547405091);
INSERT INTO data (id, data, dataset_id)
VALUES ('c7d7af5d-d17e-47ee-bd09-28b46899d230', '12, 322, 123, 53, 6,436,643', 'd99bca2f-ca4e-42b3-8e26-bc196386cc08');
INSERT INTO dataset (id, archived, datapoint_count, datapoint_max, datapoint_min, datapoint_price, description, name, uploaded_at)
VALUES ('035a4869-810b-46e6-ad74-e649643facd4', false, 7, 12124, -2342346, 1.5, 'descriptive description', 'Number of numbers per number', 1452710691);
INSERT INTO data (id, data, dataset_id)
VALUES ('4a1573cb-ee7f-416c-8ec2-d5c4b8e735e6', '123, 12124, 6543, 4246, -234234, 532, 2212', '035a4869-810b-46e6-ad74-e649643facd4');
INSERT INTO dataset (id, archived, datapoint_count, datapoint_max, datapoint_min, datapoint_price, description, name, uploaded_at)
VALUES ('ab2137ea-6a95-45a1-a538-0cb6568d7ff8', false, 4, 45395, 2, 1.5, 'This is indeed a description.', 'Data input is fun :\')', 1465839891);
INSERT INTO data (id, data, dataset_id)
VALUES ('aca18541-6d73-4343-9b31-9017b3889e42', '45395, 354,2 ,324 ,560', 'ab2137ea-6a95-45a1-a538-0cb6568d7ff8');
INSERT INTO dataset (id, archived, datapoint_count, datapoint_max, datapoint_min, datapoint_price, description, name, uploaded_at)
VALUES ('74eaf345-32e4-4141-a8f2-b5c9b7fb3089', false, 5, 6432, -324, 1.5, 'Every night, I can feel my legs', 'Why are we here, just to suffer', 1592502471);
INSERT INTO data (id, data, dataset_id)
...
VALUES ('35b14ea0-52a7-4b6b-8034-47c4034a8d7a', 1878247676, 'Cancelled', 23.34, '3f277e58-1f07-4831-ad40-a06d54912eec');
INSERT INTO users (id, display_name, email, is_admin, password)
VALUES ('6a902430-68c8-4299-a533-72773405e921', 'Joe', 'Joe@jail.ie', false, 'asdlkfjasdlkj');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('9fabc886-c62f-4c3e-b893-9a676cafc022', 1430055627, 'New', 5.6, '6a902430-68c8-4299-a533-72773405e921');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('8fca5348-170c-4b62-a239-2430ce54a8e6', 1881140574 , 'Delivered', 2.2, '6a902430-68c8-4299-a533-72773405e921');
INSERT INTO users (id, display_name, email, is_admin, password)
VALUES ('dc31adcb-1740-43fc-8fbe-ef859654fada', 'Janice', 'Janice@gmail.co.uk', false, '1234234dfajkld');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('fec3fad9-f605-4c44-bfdd-ac150fd8a5ed', 1765170888 , 'New', 100, 'dc31adcb-1740-43fc-8fbe-ef859654fada');
INSERT INTO users (id, display_name, email, is_admin, password)
...
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('46796392-1760-4fc6-aada-ec3b3c12d38e', 956778459 , 'New', 5.6, '8d6e207f-3634-484e-a7ae-0205bf0ceae2');
INSERT INTO users (id, display_name, email, is_admin, password)
VALUES ('24a203a9-d1f4-4eca-8d42-8150292c3d8e', 'Janiqua', 'Janiqua@jail.ie', false, 'asdlkfjasdlkj');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('65b7b641-698c-4851-918c-3e8a68becc64', 1372077794 , 'New', 7.9, '24a203a9-d1f4-4eca-8d42-8150292c3d8e');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('69d30c06-26b3-4cbd-b591-cef30374fadd', 1052563515 , 'Delivered', 2.2, '24a203a9-d1f4-4eca-8d42-8150292c3d8e');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('86eeb9f8-2aa3-4d1d-86bb-ffc05ce24653', 1273416060 , 'Cancelled', 23.34, '24a203a9-d1f4-4eca-8d42-8150292c3d8e');
INSERT INTO users (id, display_name, email, is_admin, password)
VALUES ('1c083586-d0d9-4ffd-aa4d-3b606bc66c14', 'Jane', 'Jane@gmail.co.uk', false, '1234234dfajkld');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('2cff0a99-b616-42d0-89b4-22c52702bd9a', 1647261814, 'New', 5.6, '1c083586-d0d9-4ffd-aa4d-3b606bc66c14');
INSERT INTO orders (id, purchased_at, state, total, user_id)
VALUES ('8d816703-46e7-4fa8-a2b2-522ac958e1fb', 1129932935 , 'Delivered', 2.2, '1c083586-d0d9-4ffd-aa4d-3b606bc66c14');
INSERT INTO users (id, display_name, email, is_admin, password)
